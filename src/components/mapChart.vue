...
export default {
  ...
  methods: {
    ...
    plusChart() {
        ...
        series: [
          {
            ...
            data: this.convertData(this.plusData),
            symbolSize: 20,
            symbol:
      ...
      // console.log('this.plusData', this.plusData)
      if (plusOption && typeof plusOption === 'object') {
        this.$echarts
          .init(document.getElementById('mapPlus'))
          .setOption(plusOption, true)
      }
    },
    clickChart() {
      this.$echarts
        ...
        .on('click', function(params) {
          ...
          if (params.componentType === 'markPoint') {
            ...
            if (params.seriesIndex === 5) {
              ...
              console.log(' 点击到了 index 为 5 的 series 的 markPoint 上')
            }
